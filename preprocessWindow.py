...
class preprocess(ctk.CTkFrame):
	def __init__(self, master, dataframe):
		...
		self.data_filter_frame = FilterPanel(self, dataframe, nonfilterlist, width = 150, corner_radius = 5)
		...
		self.filter_button.grid(row = 2, column = 0, sticky = 'sew', padx = 8, pady = (2, 8))
		
		self.preprocess_button = ctk.CTkButton(self, text = 'Preprocesar datos')
		self.preprocess_button.grid(row = 3, column = 0, sticky = 'sew', padx = 8, pady = (2, 8))
