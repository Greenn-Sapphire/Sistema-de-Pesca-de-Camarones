...
class CTkTable(customtkinter.CTkFrame):
    ...
    def __init__(
        ...
        **kwargs):
        ...
        self.column_names = column_names # the default values of the table
        ...
        self.column_corner_radius = corner_radius
        self.hover = hover
    ...
    def draw_table(self, **kwargs):
        ...
        for i in range(self.rows):
            for j in range(self.columns):
                ...
                column_corner_radius = self.corner    
                if i==0 and j==0:
                    column_corners = ["" ,fg, fg, fg]
                elif i==0 and j==self.columns-1:
                    column_corners = [fg , "", fg, fg]
                else:
                    column_corners = [fg, fg, fg, fg]
                    column_corner_radius = 0

                if self.column_names:
                    try:
                        column_name = self.column_names[i][j]
                    except IndexError: column_name = " "
                else:
                    column_name = " "
                ...
                if i == 0:
                    self.data = {"row": i, "column" : j, "value" : column_name}
                    self.frame[i,j] = customtkinter.CTkButton(self, background_corner_colors=column_corners,
                                                            corner_radius=column_corner_radius,
                                                            fg_color=fg, hover=self.hover, text=column_name, font=customtkinter.CTkFont(size=15, weight="bold"),
                ...
                self.frame[i+1,j] = customtkinter.CTkButton(self, background_corner_colors=corners,
                                                          corner_radius=corner_radius,
                                                          fg_color=fg, hover=self.hover, text=value,
                                                          command=(lambda e=self.data: self.command(e)) if self.command else None, **kwargs)
                self.frame[i+1,j].grid(column=j, row=i+1, padx=self.padx, pady=self.pady, sticky="nsew")
